  ...
  return (
    <div className="calculator-container">
      <div className="calculator-box">
        <h1 className="calculator-title">Wanda Mass Calculator - Formula 3</h1>
        <input
          type="number"
...
export default FormulaThreeCalculator;
